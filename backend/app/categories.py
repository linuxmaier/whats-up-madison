...
CATEGORY_DESCRIPTIONS: dict[str, str] = {
    ...
    "Tours & Sightseeing": "Guided tours and sightseeing: architectural and historic-site tours, museum and gallery tours, brewery and food tours, ghost/history walks, trolley/bus tours. Excludes hikes (Outdoors & Nature) and exercise walks (Health & Wellness).",
